...
const CB_ENABLED_IMAGE = require('../resources/images/check_box.png');
const CB_DISABLED_IMAGE = require('../resources/images/check_box_gray.png');
...
export default class CheckBox extends PureComponent {
    ...
    render() {
        let container = (
            <View style={this.props.containerStyle || styles.container}>
                <Image
                    ...
                    source={source} />
                {this.props.label !== '' && <View style={styles.labelContainer}>
        ...
        return (
            <TouchableHighlight accessible={this.props.accessible}
                accessibilityLabel={this.props.accessibilityLabel} testID={this.props.testID}
                onPress={this.onChange}
                disabled={this.props.disabled}
                underlayColor={this.props.underlayColor} style={styles.flexContainer}
